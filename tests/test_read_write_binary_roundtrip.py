...
def test_seq_text_binary_text_roundtrip(source, tmp_path):
    if source.stem in ('simple_mprage120', 'simple_mprage130', 'simple_mprage131', 'simple_mprage140', 'simple_mprage141', 'simple_mprage142'):
        pytest.skip(f"Skipping {source.stem} due to known differences in output.")
